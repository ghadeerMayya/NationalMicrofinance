...
class EntajiWidget extends StatefulWidget {
  const EntajiWidget({Key? key}) : super(key: key);

  @override
  _EntajiWidgetState createState() => _EntajiWidgetState();
}

class _EntajiWidgetState extends State<EntajiWidget> {
